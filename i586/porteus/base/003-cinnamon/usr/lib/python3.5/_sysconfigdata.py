...
build_time_vars = {'ABIFLAGS': 'm',
 ...
 'BUILDEXE': '',
 'BUILDPYTHON': 'python',
 'BUILD_GNU_TYPE': 'i586-slackware-linux-gnu',
 'BYTESTR_DEPS': '\\',
 'CC': 'gcc -pthread',
 'CCSHARED': '-fPIC',
 ...
 'CONFIGURE_CPPFLAGS': '',
 'CONFIGURE_LDFLAGS': '',
 'CONFIG_ARGS': "'--prefix=/usr' '--libdir=/usr/lib' '--mandir=/usr/man' "
                "'--docdir=/usr/doc/python3-3.5.2' '--with-threads' "
                "'--enable-ipv6' '--enable-shared' '--with-system-expat' "
                "'--with-system-ffi' '--build=i586-slackware-linux' "
                "'build_alias=i586-slackware-linux'",
 'CONFINCLUDEDIR': '/usr/include',
 'CONFINCLUDEPY': '/usr/include/python3.5m',
 'COREPYTHONPATH': ':plat-linux',
 'COVERAGE_INFO': '/tmp/csb/Python-3.5.2/coverage.info',
 'COVERAGE_REPORT': '/tmp/csb/Python-3.5.2/lcov-report',
 ...
 'HGTAG': '',
 'HGVERSION': '',
 'HOST_GNU_TYPE': 'i586-slackware-linux-gnu',
 ...
 'INSTALL_DATA': '/bin/ginstall -c -m 644',
 'INSTALL_PROGRAM': '/bin/ginstall -c',
 'INSTALL_SCRIPT': '/bin/ginstall -c',
 'INSTALL_SHARED': '/bin/ginstall -c -m 555',
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'LD_LIBRARY_PATH=/tmp/csb/Python-3.5.2',
 'SCRIPTDIR': '/usr/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SGI_ABI': '',
 'SHELL': '/bin/sh',
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': 'LD_LIBRARY_PATH=/tmp/csb/Python-3.5.2 ./python',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': 'LD_LIBRARY_PATH=/tmp/csb/Python-3.5.2 ./python '
 ...
 'abs_builddir': '/tmp/csb/Python-3.5.2',
 'abs_srcdir': '/tmp/csb/Python-3.5.2',
 'cross_compiling': 'no',
