...
build_time_vars = {'AC_APPLE_UNIVERSAL_BUILD': 0,
 ...
 'CONFIG_ARGS': "'--prefix=/usr' '--libdir=/usr/lib' '--mandir=/usr/man' '--docdir=/usr/doc/python-2.7.11' '--with-threads' '--enable-ipv6' '--enable-shared' '--build=i586-slackware-linux' 'build_alias=i586-slackware-linux' 'PKG_CONFIG_PATH=/usr/local/lib/pkgconfig:/usr/lib/pkgconfig'",
