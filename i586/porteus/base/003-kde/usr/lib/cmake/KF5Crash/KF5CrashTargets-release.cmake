...
set_target_properties(KF5::Crash PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libKF5Crash.so.5.45.0"
  IMPORTED_SONAME_RELEASE "libKF5Crash.so.5"
  )

list(APPEND _IMPORT_CHECK_TARGETS KF5::Crash )
list(APPEND _IMPORT_CHECK_FILES_FOR_KF5::Crash "${_IMPORT_PREFIX}/lib/libKF5Crash.so.5.45.0" )
