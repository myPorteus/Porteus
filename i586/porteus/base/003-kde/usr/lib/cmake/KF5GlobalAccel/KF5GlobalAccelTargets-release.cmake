...
set_target_properties(KF5::GlobalAccel PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libKF5GlobalAccel.so.5.45.0"
  IMPORTED_SONAME_RELEASE "libKF5GlobalAccel.so.5"
  )

list(APPEND _IMPORT_CHECK_TARGETS KF5::GlobalAccel )
list(APPEND _IMPORT_CHECK_FILES_FOR_KF5::GlobalAccel "${_IMPORT_PREFIX}/lib/libKF5GlobalAccel.so.5.45.0" )
...
set_target_properties(KF5::GlobalAccelPrivate PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libKF5GlobalAccelPrivate.so.5.45.0"
  IMPORTED_SONAME_RELEASE "libKF5GlobalAccelPrivate.so.5"
  )

list(APPEND _IMPORT_CHECK_TARGETS KF5::GlobalAccelPrivate )
list(APPEND _IMPORT_CHECK_FILES_FOR_KF5::GlobalAccelPrivate "${_IMPORT_PREFIX}/lib/libKF5GlobalAccelPrivate.so.5.45.0" )
