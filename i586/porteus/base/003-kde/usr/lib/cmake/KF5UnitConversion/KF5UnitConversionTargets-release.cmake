...
set_target_properties(KF5::UnitConversion PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libKF5UnitConversion.so.5.45.0"
  IMPORTED_SONAME_RELEASE "libKF5UnitConversion.so.5"
  )

list(APPEND _IMPORT_CHECK_TARGETS KF5::UnitConversion )
list(APPEND _IMPORT_CHECK_FILES_FOR_KF5::UnitConversion "${_IMPORT_PREFIX}/lib/libKF5UnitConversion.so.5.45.0" )
