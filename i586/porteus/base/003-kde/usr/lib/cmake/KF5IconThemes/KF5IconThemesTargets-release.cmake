...
set_target_properties(KF5::IconThemes PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libKF5IconThemes.so.5.45.0"
  IMPORTED_SONAME_RELEASE "libKF5IconThemes.so.5"
  )

list(APPEND _IMPORT_CHECK_TARGETS KF5::IconThemes )
list(APPEND _IMPORT_CHECK_FILES_FOR_KF5::IconThemes "${_IMPORT_PREFIX}/lib/libKF5IconThemes.so.5.45.0" )
