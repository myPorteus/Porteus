...
if (NOT TARGET Qt5::X11Extras)
    ...
    set(Qt5X11Extras_PRIVATE_INCLUDE_DIRS
        "${_qt5X11Extras_install_prefix}/include/qt5/QtX11Extras/5.9.5"
        "${_qt5X11Extras_install_prefix}/include/qt5/QtX11Extras/5.9.5/QtX11Extras"
    )
    ...
    macro(_populate_X11Extras_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5X11Extras_install_prefix}/lib/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_X11Extras_check_file_exists(${imported_location})
