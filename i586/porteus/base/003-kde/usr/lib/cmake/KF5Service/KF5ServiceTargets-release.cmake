...
set_target_properties(KF5::Service PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libKF5Service.so.5.45.0"
  IMPORTED_SONAME_RELEASE "libKF5Service.so.5"
  )

list(APPEND _IMPORT_CHECK_TARGETS KF5::Service )
list(APPEND _IMPORT_CHECK_FILES_FOR_KF5::Service "${_IMPORT_PREFIX}/lib/libKF5Service.so.5.45.0" )
