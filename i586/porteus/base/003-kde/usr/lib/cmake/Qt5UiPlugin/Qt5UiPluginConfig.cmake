...
if (NOT TARGET Qt5::UiPlugin)
    ...
    set(Qt5UiPlugin_PRIVATE_INCLUDE_DIRS
        "${_qt5UiPlugin_install_prefix}/include/qt5/QtUiPlugin/5.9.5"
        "${_qt5UiPlugin_install_prefix}/include/qt5/QtUiPlugin/5.9.5/QtUiPlugin"
    )
    ...
    macro(_populate_UiPlugin_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5UiPlugin_install_prefix}/lib/qt5/plugins/${PLUGIN_LOCATION}")
