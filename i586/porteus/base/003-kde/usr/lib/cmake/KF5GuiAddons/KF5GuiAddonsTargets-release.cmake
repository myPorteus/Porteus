...
set_target_properties(KF5::GuiAddons PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libKF5GuiAddons.so.5.45.0"
  IMPORTED_SONAME_RELEASE "libKF5GuiAddons.so.5"
  )

list(APPEND _IMPORT_CHECK_TARGETS KF5::GuiAddons )
list(APPEND _IMPORT_CHECK_FILES_FOR_KF5::GuiAddons "${_IMPORT_PREFIX}/lib/libKF5GuiAddons.so.5.45.0" )
