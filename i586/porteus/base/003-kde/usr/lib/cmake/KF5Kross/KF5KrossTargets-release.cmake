...
set_target_properties(KF5::KrossCore PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libKF5KrossCore.so.5.45.0"
  IMPORTED_SONAME_RELEASE "libKF5KrossCore.so.5"
  )

list(APPEND _IMPORT_CHECK_TARGETS KF5::KrossCore )
list(APPEND _IMPORT_CHECK_FILES_FOR_KF5::KrossCore "${_IMPORT_PREFIX}/lib/libKF5KrossCore.so.5.45.0" )
...
set_target_properties(KF5::KrossUi PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libKF5KrossUi.so.5.45.0"
  IMPORTED_SONAME_RELEASE "libKF5KrossUi.so.5"
  )

list(APPEND _IMPORT_CHECK_TARGETS KF5::KrossUi )
list(APPEND _IMPORT_CHECK_FILES_FOR_KF5::KrossUi "${_IMPORT_PREFIX}/lib/libKF5KrossUi.so.5.45.0" )
