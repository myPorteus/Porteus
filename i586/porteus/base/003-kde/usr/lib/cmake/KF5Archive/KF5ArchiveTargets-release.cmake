...
set_target_properties(KF5::Archive PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libKF5Archive.so.5.45.0"
  IMPORTED_SONAME_RELEASE "libKF5Archive.so.5"
  )

list(APPEND _IMPORT_CHECK_TARGETS KF5::Archive )
list(APPEND _IMPORT_CHECK_FILES_FOR_KF5::Archive "${_IMPORT_PREFIX}/lib/libKF5Archive.so.5.45.0" )
