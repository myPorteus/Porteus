...
set_target_properties(KF5::FileMetaData PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libKF5FileMetaData.so.5.45.0"
  IMPORTED_SONAME_RELEASE "libKF5FileMetaData.so.3"
  )

list(APPEND _IMPORT_CHECK_TARGETS KF5::FileMetaData )
list(APPEND _IMPORT_CHECK_FILES_FOR_KF5::FileMetaData "${_IMPORT_PREFIX}/lib/libKF5FileMetaData.so.5.45.0" )
