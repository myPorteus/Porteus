...
set_target_properties(Phonon::phonon4qt5 PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libphonon4qt5.so.4.10.0"
  IMPORTED_SONAME_RELEASE "libphonon4qt5.so.4"
  )

list(APPEND _IMPORT_CHECK_TARGETS Phonon::phonon4qt5 )
list(APPEND _IMPORT_CHECK_FILES_FOR_Phonon::phonon4qt5 "${_IMPORT_PREFIX}/lib/libphonon4qt5.so.4.10.0" )
