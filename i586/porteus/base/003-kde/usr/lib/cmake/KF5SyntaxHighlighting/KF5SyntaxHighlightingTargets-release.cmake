...
set_target_properties(KF5::SyntaxHighlighting PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libKF5SyntaxHighlighting.so.5.45.0"
  IMPORTED_SONAME_RELEASE "libKF5SyntaxHighlighting.so.5"
  )

list(APPEND _IMPORT_CHECK_TARGETS KF5::SyntaxHighlighting )
list(APPEND _IMPORT_CHECK_FILES_FOR_KF5::SyntaxHighlighting "${_IMPORT_PREFIX}/lib/libKF5SyntaxHighlighting.so.5.45.0" )
