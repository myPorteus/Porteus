...
set_target_properties(KF5::JS PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libKF5JS.so.5.45.0"
  IMPORTED_SONAME_RELEASE "libKF5JS.so.5"
  )

list(APPEND _IMPORT_CHECK_TARGETS KF5::JS )
list(APPEND _IMPORT_CHECK_FILES_FOR_KF5::JS "${_IMPORT_PREFIX}/lib/libKF5JS.so.5.45.0" )
...
set_target_properties(KF5::JSApi PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libKF5JSApi.so.5.45.0"
  IMPORTED_SONAME_RELEASE "libKF5JSApi.so.5"
  )

list(APPEND _IMPORT_CHECK_TARGETS KF5::JSApi )
list(APPEND _IMPORT_CHECK_FILES_FOR_KF5::JSApi "${_IMPORT_PREFIX}/lib/libKF5JSApi.so.5.45.0" )
