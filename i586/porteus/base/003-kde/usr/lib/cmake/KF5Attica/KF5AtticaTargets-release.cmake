...
set_target_properties(KF5::Attica PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libKF5Attica.so.5.45.0"
  IMPORTED_SONAME_RELEASE "libKF5Attica.so.5"
  )

list(APPEND _IMPORT_CHECK_TARGETS KF5::Attica )
list(APPEND _IMPORT_CHECK_FILES_FOR_KF5::Attica "${_IMPORT_PREFIX}/lib/libKF5Attica.so.5.45.0" )
