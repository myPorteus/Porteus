...
set_target_properties(KF5::NetworkManagerQt PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libKF5NetworkManagerQt.so.5.45.0"
  IMPORTED_SONAME_RELEASE "libKF5NetworkManagerQt.so.6"
  )

list(APPEND _IMPORT_CHECK_TARGETS KF5::NetworkManagerQt )
list(APPEND _IMPORT_CHECK_FILES_FOR_KF5::NetworkManagerQt "${_IMPORT_PREFIX}/lib/libKF5NetworkManagerQt.so.5.45.0" )
