...
if (NOT TARGET Qt5::UiTools)
    ...
    set(Qt5UiTools_PRIVATE_INCLUDE_DIRS
        "${_qt5UiTools_install_prefix}/include/qt5/QtUiTools/5.9.5"
        "${_qt5UiTools_install_prefix}/include/qt5/QtUiTools/5.9.5/QtUiTools"
    )
    ...
    macro(_populate_UiTools_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5UiTools_install_prefix}/lib/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_UiTools_check_file_exists(${imported_location})
