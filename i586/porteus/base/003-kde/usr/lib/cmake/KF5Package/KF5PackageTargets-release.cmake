...
set_target_properties(KF5::Package PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libKF5Package.so.5.45.0"
  IMPORTED_SONAME_RELEASE "libKF5Package.so.5"
  )

list(APPEND _IMPORT_CHECK_TARGETS KF5::Package )
list(APPEND _IMPORT_CHECK_FILES_FOR_KF5::Package "${_IMPORT_PREFIX}/lib/libKF5Package.so.5.45.0" )
