...
set_target_properties(KF5::KExiv2 PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libKF5KExiv2.so.5.0.0"
  IMPORTED_SONAME_RELEASE "libKF5KExiv2.so.15.0.0"
  )

list(APPEND _IMPORT_CHECK_TARGETS KF5::KExiv2 )
list(APPEND _IMPORT_CHECK_FILES_FOR_KF5::KExiv2 "${_IMPORT_PREFIX}/lib/libKF5KExiv2.so.5.0.0" )
