...
set_target_properties(KF5::Plotting PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libKF5Plotting.so.5.45.0"
  IMPORTED_SONAME_RELEASE "libKF5Plotting.so.5"
  )

list(APPEND _IMPORT_CHECK_TARGETS KF5::Plotting )
list(APPEND _IMPORT_CHECK_FILES_FOR_KF5::Plotting "${_IMPORT_PREFIX}/lib/libKF5Plotting.so.5.45.0" )
