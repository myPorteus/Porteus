...
set_target_properties(PW::LibColorCorrect PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libcolorcorrect.so.5.12.3"
  IMPORTED_SONAME_RELEASE "libcolorcorrect.so.5"
  )

list(APPEND _IMPORT_CHECK_TARGETS PW::LibColorCorrect )
list(APPEND _IMPORT_CHECK_FILES_FOR_PW::LibColorCorrect "${_IMPORT_PREFIX}/lib/libcolorcorrect.so.5.12.3" )
