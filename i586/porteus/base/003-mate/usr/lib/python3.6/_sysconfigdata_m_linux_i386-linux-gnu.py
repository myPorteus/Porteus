...
build_time_vars = {'ABIFLAGS': 'm',
 ...
 'CONFIG_ARGS': "'--prefix=/usr' '--libdir=/usr/lib' '--mandir=/usr/man' "
                "'--docdir=/usr/doc/python3-3.6.5' '--with-threads' "
 ...
 'LIBPL': '/usr/lib/python3.6/config-3.6m-i386-linux-gnu',
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'LD_LIBRARY_PATH=/tmp/Python-3.6.5',
 'SCRIPTDIR': '/usr/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SGI_ABI': '',
 'SHELL': '/bin/sh',
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': 'LD_LIBRARY_PATH=/tmp/Python-3.6.5 ./python',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': 'LD_LIBRARY_PATH=/tmp/Python-3.6.5 ./python '
