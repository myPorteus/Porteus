...
build_time_vars = {'AC_APPLE_UNIVERSAL_BUILD': 0,
 ...
 'CONFIG_ARGS': "'--prefix=/usr' '--libdir=/usr/lib' '--mandir=/usr/man' '--docdir=/usr/doc/python-2.7.14' '--with-threads' '--enable-ipv6' '--enable-shared' '--enable-unicode=ucs4' '--with-system-expat' '--with-system-ffi' '--without-ensurepip' '--build=i586-slackware-linux' 'build_alias=i586-slackware-linux' 'PKG_CONFIG_PATH=/usr/local/lib/pkgconfig:/usr/local/share/pkgconfig:/usr/lib/pkgconfig:/usr/share/pkgconfig'",
 'CONFINCLUDEDIR': '/usr/include',
 'CONFINCLUDEPY': '/usr/include/python2.7',
 'COREPYTHONPATH': ':plat-linux2:lib-tk:lib-old',
 'COVERAGE_INFO': '/tmp/Python-2.7.14/coverage.info',
 'COVERAGE_REPORT': '/tmp/Python-2.7.14/lcov-report',
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'LD_LIBRARY_PATH=/tmp/Python-2.7.14',
 'SCRIPTDIR': '/usr/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SGI_ABI': '',
 'SHELL': '/bin/sh',
 ...
 'TESTPYTHON': 'LD_LIBRARY_PATH=/tmp/Python-2.7.14 ./python -Wd -3 -E -tt',
 'TESTPYTHONOPTS': '',
 ...
 'abs_builddir': '/tmp/Python-2.7.14',
 'abs_srcdir': '/tmp/Python-2.7.14',
 'build': 'i586-slackware-linux-gnu',
 'datarootdir': '/usr/share',
 'exec_prefix': '/usr',
 'host': 'i586-slackware-linux-gnu',
 'prefix': '/usr',
 'srcdir': '.'}
