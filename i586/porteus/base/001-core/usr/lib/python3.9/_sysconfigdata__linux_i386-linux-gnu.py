...
build_time_vars = {'ABIFLAGS': '',
 ...
 'CONFIG_ARGS': "'--prefix=/usr' '--libdir=/usr/lib' '--with-platlibdir=lib' "
                "'--mandir=/usr/man' '--docdir=/usr/doc/python3-3.9.6' "
                "'--enable-ipv6' '--enable-shared' '--with-system-expat' "
                "'--with-system-ffi' '--enable-loadable-sqlite-extensions' "
                "'--without-ensurepip' '--build=i586-slackware-linux' "
 ...
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/tmp/Python-3.9.6/coverage.info',
 'COVERAGE_REPORT': '/tmp/Python-3.9.6/lcov-report',
 ...
 'LIBPL': '/usr/lib/python3.9/config-3.9-i386-linux-gnu',
 'LIBPYTHON': '',
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'LD_LIBRARY_PATH=/tmp/Python-3.9.6',
 'SCRIPTDIR': '/usr/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SGI_ABI': '@SGI_ABI@',
 'SHELL': '/bin/sh',
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': 'LD_LIBRARY_PATH=/tmp/Python-3.9.6 ./python',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': 'LD_LIBRARY_PATH=/tmp/Python-3.9.6 ./python '
 ...
 'abs_builddir': '/tmp/Python-3.9.6',
 'abs_srcdir': '/tmp/Python-3.9.6',
