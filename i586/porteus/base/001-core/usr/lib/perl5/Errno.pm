...
"i586-linux-thread-multi-4.4.8-smp" or
	die "Errno architecture (i586-linux-thread-multi-4.4.8-smp) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
