...
"i586-linux-thread-multi-4.14.15-smp" or
	die "Errno architecture (i586-linux-thread-multi-4.14.15-smp) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
