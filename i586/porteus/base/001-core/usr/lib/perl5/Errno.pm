...
"i586-linux-thread-multi-5.10.38-smp" or
	die "Errno architecture (i586-linux-thread-multi-5.10.38-smp) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
