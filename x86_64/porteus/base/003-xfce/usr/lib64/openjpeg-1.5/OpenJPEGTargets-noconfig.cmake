...
# Import target "openjpeg_JPWL" for configuration ""
set_property(TARGET openjpeg_JPWL APPEND PROPERTY IMPORTED_CONFIGURATIONS NOCONFIG)
set_target_properties(openjpeg_JPWL PROPERTIES
  IMPORTED_LINK_INTERFACE_LIBRARIES_NOCONFIG "m"
  IMPORTED_LOCATION_NOCONFIG "${_IMPORT_PREFIX}/lib64/libopenjpeg_JPWL.so.1.5.1"
  IMPORTED_SONAME_NOCONFIG "libopenjpeg_JPWL.so.5"
  )

list(APPEND _IMPORT_CHECK_TARGETS openjpeg_JPWL )
list(APPEND _IMPORT_CHECK_FILES_FOR_openjpeg_JPWL "${_IMPORT_PREFIX}/lib64/libopenjpeg_JPWL.so.1.5.1" )
...
set_target_properties(openjpeg PROPERTIES
  IMPORTED_LINK_INTERFACE_LIBRARIES_NOCONFIG "m"
  IMPORTED_LOCATION_NOCONFIG "${_IMPORT_PREFIX}/lib64/libopenjpeg.so.1.5.1"
  IMPORTED_SONAME_NOCONFIG "libopenjpeg.so.5"
  )

list(APPEND _IMPORT_CHECK_TARGETS openjpeg )
list(APPEND _IMPORT_CHECK_FILES_FOR_openjpeg "${_IMPORT_PREFIX}/lib64/libopenjpeg.so.1.5.1" )
