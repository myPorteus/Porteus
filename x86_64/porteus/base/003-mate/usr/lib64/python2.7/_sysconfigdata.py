...
build_time_vars = {'AC_APPLE_UNIVERSAL_BUILD': 0,
 ...
 'CONFIG_ARGS': "'--prefix=/usr' '--libdir=/usr/lib64' '--mandir=/usr/man' '--docdir=/usr/doc/python-2.7.11' '--with-threads' '--enable-ipv6' '--enable-shared' '--build=x86_64-slackware-linux' 'build_alias=x86_64-slackware-linux' 'PKG_CONFIG_PATH=/usr/local/lib64/pkgconfig:/usr/lib64/pkgconfig'",
