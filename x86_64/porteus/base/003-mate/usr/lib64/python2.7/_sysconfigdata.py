...
build_time_vars = {'AC_APPLE_UNIVERSAL_BUILD': 0,
 ...
 'CONFIG_ARGS': "'--prefix=/usr' '--libdir=/usr/lib64' '--mandir=/usr/man' '--docdir=/usr/doc/python-2.7.5' '--with-threads' '--enable-ipv6' '--enable-shared' '--build=x86_64-slackware-linux' 'build_alias=x86_64-slackware-linux'",
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'LD_LIBRARY_PATH=/tmp/Python-2.7.5:',
 'SCRIPTDIR': '/usr/lib64',
 'SETPGRP_HAVE_ARG': 0,
 'SGI_ABI': '',
 'SHELL': '/bin/sh',
 ...
 'TESTPYTHON': 'LD_LIBRARY_PATH=/tmp/Python-2.7.5: ./python -Wd -3 -E -tt',
 'TESTPYTHONOPTS': '',
 ...
 'abs_builddir': '/tmp/Python-2.7.5',
 'abs_srcdir': '/tmp/Python-2.7.5',
