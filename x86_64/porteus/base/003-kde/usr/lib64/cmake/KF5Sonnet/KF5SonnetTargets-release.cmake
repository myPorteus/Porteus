...
set_target_properties(KF5::SonnetCore PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libKF5SonnetCore.so.5.45.0"
  IMPORTED_SONAME_RELEASE "libKF5SonnetCore.so.5"
  )

list(APPEND _IMPORT_CHECK_TARGETS KF5::SonnetCore )
list(APPEND _IMPORT_CHECK_FILES_FOR_KF5::SonnetCore "${_IMPORT_PREFIX}/lib64/libKF5SonnetCore.so.5.45.0" )
...
set_target_properties(KF5::SonnetUi PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libKF5SonnetUi.so.5.45.0"
  IMPORTED_SONAME_RELEASE "libKF5SonnetUi.so.5"
  )

list(APPEND _IMPORT_CHECK_TARGETS KF5::SonnetUi )
list(APPEND _IMPORT_CHECK_FILES_FOR_KF5::SonnetUi "${_IMPORT_PREFIX}/lib64/libKF5SonnetUi.so.5.45.0" )
