...
get_filename_component(_realOrig "/usr/lib64/cmake/Qt5QuickTemplates2" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5QuickTemplates2_install_prefix "/usr/lib64/../" ABSOLUTE)
else()
...
macro(_populate_QuickTemplates2_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_location "${_qt5QuickTemplates2_install_prefix}/lib64/${LIB_LOCATION}")
...
if (NOT TARGET Qt5::QuickTemplates2)
    ...
    set(Qt5QuickTemplates2_PRIVATE_INCLUDE_DIRS
        "${_qt5QuickTemplates2_install_prefix}/include/qt5/QtQuickTemplates2/5.12.3"
        "${_qt5QuickTemplates2_install_prefix}/include/qt5/QtQuickTemplates2/5.12.3/QtQuickTemplates2"
    )
    ...
    _populate_QuickTemplates2_target_properties(RELEASE "libQt5QuickTemplates2.so.5.12.3" "" )
    ...
    macro(_populate_QuickTemplates2_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5QuickTemplates2_install_prefix}/lib64/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_QuickTemplates2_check_file_exists(${imported_location})
