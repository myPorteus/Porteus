...
set_target_properties(KF5::BalooWidgets PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libKF5BalooWidgets.so.5.0.0"
  IMPORTED_SONAME_RELEASE "libKF5BalooWidgets.so.5"
  )

list(APPEND _IMPORT_CHECK_TARGETS KF5::BalooWidgets )
list(APPEND _IMPORT_CHECK_FILES_FOR_KF5::BalooWidgets "${_IMPORT_PREFIX}/lib64/libKF5BalooWidgets.so.5.0.0" )
