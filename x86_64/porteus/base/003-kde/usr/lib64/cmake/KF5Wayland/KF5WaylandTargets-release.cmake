...
set_target_properties(KF5::WaylandClient PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libKF5WaylandClient.so.5.58.0"
  IMPORTED_SONAME_RELEASE "libKF5WaylandClient.so.5"
  )

list(APPEND _IMPORT_CHECK_TARGETS KF5::WaylandClient )
list(APPEND _IMPORT_CHECK_FILES_FOR_KF5::WaylandClient "${_IMPORT_PREFIX}/lib64/libKF5WaylandClient.so.5.58.0" )
...
set_target_properties(KF5::WaylandServer PROPERTIES
  IMPORTED_LINK_DEPENDENT_LIBRARIES_RELEASE "Qt5::Concurrent"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libKF5WaylandServer.so.5.58.0"
  IMPORTED_SONAME_RELEASE "libKF5WaylandServer.so.5"
  )

list(APPEND _IMPORT_CHECK_TARGETS KF5::WaylandServer )
list(APPEND _IMPORT_CHECK_FILES_FOR_KF5::WaylandServer "${_IMPORT_PREFIX}/lib64/libKF5WaylandServer.so.5.58.0" )
