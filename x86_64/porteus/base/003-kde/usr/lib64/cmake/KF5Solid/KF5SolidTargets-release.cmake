...
set_target_properties(KF5::Solid PROPERTIES
  IMPORTED_LINK_DEPENDENT_LIBRARIES_RELEASE "Qt5::Xml;Qt5::Widgets;Qt5::DBus"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libKF5Solid.so.5.58.0"
  IMPORTED_SONAME_RELEASE "libKF5Solid.so.5"
  )

list(APPEND _IMPORT_CHECK_TARGETS KF5::Solid )
list(APPEND _IMPORT_CHECK_FILES_FOR_KF5::Solid "${_IMPORT_PREFIX}/lib64/libKF5Solid.so.5.58.0" )
