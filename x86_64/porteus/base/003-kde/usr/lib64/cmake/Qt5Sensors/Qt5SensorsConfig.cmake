...
get_filename_component(_realOrig "/usr/lib64/cmake/Qt5Sensors" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5Sensors_install_prefix "/usr/lib64/../" ABSOLUTE)
else()
...
macro(_populate_Sensors_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_location "${_qt5Sensors_install_prefix}/lib64/${LIB_LOCATION}")
...
if (NOT TARGET Qt5::Sensors)
    ...
    set(Qt5Sensors_PRIVATE_INCLUDE_DIRS
        "${_qt5Sensors_install_prefix}/include/qt5/QtSensors/5.12.3"
        "${_qt5Sensors_install_prefix}/include/qt5/QtSensors/5.12.3/QtSensors"
    )
    ...
    _populate_Sensors_target_properties(RELEASE "libQt5Sensors.so.5.12.3" "" )
    ...
    macro(_populate_Sensors_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5Sensors_install_prefix}/lib64/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_Sensors_check_file_exists(${imported_location})
