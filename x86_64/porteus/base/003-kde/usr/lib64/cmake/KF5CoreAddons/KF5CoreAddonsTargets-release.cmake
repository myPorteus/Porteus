...
set_target_properties(KF5::CoreAddons PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libKF5CoreAddons.so.5.45.0"
  IMPORTED_SONAME_RELEASE "libKF5CoreAddons.so.5"
  )

list(APPEND _IMPORT_CHECK_TARGETS KF5::CoreAddons )
list(APPEND _IMPORT_CHECK_FILES_FOR_KF5::CoreAddons "${_IMPORT_PREFIX}/lib64/libKF5CoreAddons.so.5.45.0" )
