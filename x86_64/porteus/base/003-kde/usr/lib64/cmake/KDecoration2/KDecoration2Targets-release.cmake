...
set_target_properties(KDecoration2::KDecoration2Private PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libkdecorations2private.so.5.12.3"
  IMPORTED_SONAME_RELEASE "libkdecorations2private.so.5"
  )

list(APPEND _IMPORT_CHECK_TARGETS KDecoration2::KDecoration2Private )
list(APPEND _IMPORT_CHECK_FILES_FOR_KDecoration2::KDecoration2Private "${_IMPORT_PREFIX}/lib64/libkdecorations2private.so.5.12.3" )
...
set_target_properties(KDecoration2::KDecoration PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libkdecorations2.so.5.12.3"
  IMPORTED_SONAME_RELEASE "libkdecorations2.so.5"
  )

list(APPEND _IMPORT_CHECK_TARGETS KDecoration2::KDecoration )
list(APPEND _IMPORT_CHECK_FILES_FOR_KDecoration2::KDecoration "${_IMPORT_PREFIX}/lib64/libkdecorations2.so.5.12.3" )
