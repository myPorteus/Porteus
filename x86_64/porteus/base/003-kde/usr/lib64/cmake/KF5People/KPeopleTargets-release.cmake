...
set_target_properties(KF5::PeopleWidgets PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libKF5PeopleWidgets.so.5.58.0"
  IMPORTED_SONAME_RELEASE "libKF5PeopleWidgets.so.5"
  )

list(APPEND _IMPORT_CHECK_TARGETS KF5::PeopleWidgets )
list(APPEND _IMPORT_CHECK_FILES_FOR_KF5::PeopleWidgets "${_IMPORT_PREFIX}/lib64/libKF5PeopleWidgets.so.5.58.0" )
...
set_target_properties(KF5::PeopleBackend PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libKF5PeopleBackend.so.5.58.0"
  IMPORTED_SONAME_RELEASE "libKF5PeopleBackend.so.5"
  )

list(APPEND _IMPORT_CHECK_TARGETS KF5::PeopleBackend )
list(APPEND _IMPORT_CHECK_FILES_FOR_KF5::PeopleBackend "${_IMPORT_PREFIX}/lib64/libKF5PeopleBackend.so.5.58.0" )
...
set_target_properties(KF5::People PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libKF5People.so.5.58.0"
  IMPORTED_SONAME_RELEASE "libKF5People.so.5"
  )

list(APPEND _IMPORT_CHECK_TARGETS KF5::People )
list(APPEND _IMPORT_CHECK_FILES_FOR_KF5::People "${_IMPORT_PREFIX}/lib64/libKF5People.so.5.58.0" )
