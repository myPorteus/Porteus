...
set_target_properties(KioArchive PROPERTIES
  IMPORTED_LINK_DEPENDENT_LIBRARIES_RELEASE "KF5::I18n;Qt5::Network;Qt5::DBus"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libkioarchive.so.5.97.0"
  IMPORTED_SONAME_RELEASE "libkioarchive.so.5"
  )

list(APPEND _IMPORT_CHECK_TARGETS KioArchive )
list(APPEND _IMPORT_CHECK_FILES_FOR_KioArchive "${_IMPORT_PREFIX}/lib64/libkioarchive.so.5.97.0" )
