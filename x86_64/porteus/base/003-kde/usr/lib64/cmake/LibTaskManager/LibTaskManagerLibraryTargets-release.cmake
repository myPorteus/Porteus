...
set_target_properties(PW::LibTaskManager PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libtaskmanager.so.5.12.3"
  IMPORTED_SONAME_RELEASE "libtaskmanager.so.6"
  )

list(APPEND _IMPORT_CHECK_TARGETS PW::LibTaskManager )
list(APPEND _IMPORT_CHECK_FILES_FOR_PW::LibTaskManager "${_IMPORT_PREFIX}/lib64/libtaskmanager.so.5.12.3" )
