...
set_target_properties(KF5::Baloo PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libKF5Baloo.so.5.45.0"
  IMPORTED_SONAME_RELEASE "libKF5Baloo.so.5"
  )

list(APPEND _IMPORT_CHECK_TARGETS KF5::Baloo )
list(APPEND _IMPORT_CHECK_FILES_FOR_KF5::Baloo "${_IMPORT_PREFIX}/lib64/libKF5Baloo.so.5.45.0" )
...
set_target_properties(KF5::BalooEngine PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libKF5BalooEngine.so.5.45.0"
  IMPORTED_SONAME_RELEASE "libKF5BalooEngine.so.5"
  )

list(APPEND _IMPORT_CHECK_TARGETS KF5::BalooEngine )
list(APPEND _IMPORT_CHECK_FILES_FOR_KF5::BalooEngine "${_IMPORT_PREFIX}/lib64/libKF5BalooEngine.so.5.45.0" )
