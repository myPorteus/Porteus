...
set_target_properties(KF5::Service PROPERTIES
  IMPORTED_LINK_DEPENDENT_LIBRARIES_RELEASE "KF5::I18n;Qt5::Xml;KF5::DBusAddons"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libKF5Service.so.5.58.0"
  IMPORTED_SONAME_RELEASE "libKF5Service.so.5"
  )

list(APPEND _IMPORT_CHECK_TARGETS KF5::Service )
list(APPEND _IMPORT_CHECK_FILES_FOR_KF5::Service "${_IMPORT_PREFIX}/lib64/libKF5Service.so.5.58.0" )
