...
set_target_properties(KF5::ModemManagerQt PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libKF5ModemManagerQt.so.5.58.0"
  IMPORTED_SONAME_RELEASE "libKF5ModemManagerQt.so.6"
  )

list(APPEND _IMPORT_CHECK_TARGETS KF5::ModemManagerQt )
list(APPEND _IMPORT_CHECK_FILES_FOR_KF5::ModemManagerQt "${_IMPORT_PREFIX}/lib64/libKF5ModemManagerQt.so.5.58.0" )
