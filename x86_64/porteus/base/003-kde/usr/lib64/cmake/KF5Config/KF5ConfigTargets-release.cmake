...
set_target_properties(KF5::ConfigCore PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libKF5ConfigCore.so.5.45.0"
  IMPORTED_SONAME_RELEASE "libKF5ConfigCore.so.5"
  )

list(APPEND _IMPORT_CHECK_TARGETS KF5::ConfigCore )
list(APPEND _IMPORT_CHECK_FILES_FOR_KF5::ConfigCore "${_IMPORT_PREFIX}/lib64/libKF5ConfigCore.so.5.45.0" )
...
set_target_properties(KF5::ConfigGui PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libKF5ConfigGui.so.5.45.0"
  IMPORTED_SONAME_RELEASE "libKF5ConfigGui.so.5"
  )

list(APPEND _IMPORT_CHECK_TARGETS KF5::ConfigGui )
list(APPEND _IMPORT_CHECK_FILES_FOR_KF5::ConfigGui "${_IMPORT_PREFIX}/lib64/libKF5ConfigGui.so.5.45.0" )
