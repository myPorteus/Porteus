...
set_target_properties(KF5::Declarative PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libKF5Declarative.so.5.58.0"
  IMPORTED_SONAME_RELEASE "libKF5Declarative.so.5"
  )

list(APPEND _IMPORT_CHECK_TARGETS KF5::Declarative )
list(APPEND _IMPORT_CHECK_FILES_FOR_KF5::Declarative "${_IMPORT_PREFIX}/lib64/libKF5Declarative.so.5.58.0" )
...
set_target_properties(KF5::QuickAddons PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libKF5QuickAddons.so.5.58.0"
  IMPORTED_SONAME_RELEASE "libKF5QuickAddons.so.5"
  )

list(APPEND _IMPORT_CHECK_TARGETS KF5::QuickAddons )
list(APPEND _IMPORT_CHECK_FILES_FOR_KF5::QuickAddons "${_IMPORT_PREFIX}/lib64/libKF5QuickAddons.so.5.58.0" )
...
set_target_properties(KF5::CalendarEvents PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libKF5CalendarEvents.so.5.58.0"
  IMPORTED_SONAME_RELEASE "libKF5CalendarEvents.so.5"
  )

list(APPEND _IMPORT_CHECK_TARGETS KF5::CalendarEvents )
list(APPEND _IMPORT_CHECK_FILES_FOR_KF5::CalendarEvents "${_IMPORT_PREFIX}/lib64/libKF5CalendarEvents.so.5.58.0" )
