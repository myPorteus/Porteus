...
get_filename_component(_realOrig "/usr/lib64/cmake/Qt5QuickControls2" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5QuickControls2_install_prefix "/usr/lib64/../" ABSOLUTE)
else()
...
macro(_populate_QuickControls2_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_location "${_qt5QuickControls2_install_prefix}/lib64/${LIB_LOCATION}")
...
if (NOT TARGET Qt5::QuickControls2)
    ...
    set(Qt5QuickControls2_PRIVATE_INCLUDE_DIRS
        "${_qt5QuickControls2_install_prefix}/include/qt5/QtQuickControls2/5.12.3"
        "${_qt5QuickControls2_install_prefix}/include/qt5/QtQuickControls2/5.12.3/QtQuickControls2"
    )
    ...
    _populate_QuickControls2_target_properties(RELEASE "libQt5QuickControls2.so.5.12.3" "" )
    ...
    macro(_populate_QuickControls2_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5QuickControls2_install_prefix}/lib64/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_QuickControls2_check_file_exists(${imported_location})
