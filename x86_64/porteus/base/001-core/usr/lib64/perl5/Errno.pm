...
"x86_64-linux-thread-multi-4.19.44" or
	die "Errno architecture (x86_64-linux-thread-multi-4.19.44) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
