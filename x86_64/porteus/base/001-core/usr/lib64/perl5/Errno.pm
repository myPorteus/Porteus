...
"x86_64-linux-thread-multi-4.4.8" or
	die "Errno architecture (x86_64-linux-thread-multi-4.4.8) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
