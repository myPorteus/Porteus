...
"x86_64-linux-thread-multi-3.10.9" or
	die "Errno architecture (x86_64-linux-thread-multi-3.10.9) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
