...
"x86_64-linux-thread-multi-5.4.47" or
	die "Errno architecture (x86_64-linux-thread-multi-5.4.47) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
