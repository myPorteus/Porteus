...
"x86_64-linux-thread-multi-4.14.15" or
	die "Errno architecture (x86_64-linux-thread-multi-4.14.15) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
