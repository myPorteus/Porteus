...
"x86_64-linux-thread-multi-5.10.38" or
	die "Errno architecture (x86_64-linux-thread-multi-5.10.38) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
