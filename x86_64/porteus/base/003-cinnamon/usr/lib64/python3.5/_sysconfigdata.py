...
build_time_vars = {'ABIFLAGS': 'm',
 ...
 'BUILDEXE': '',
 'BUILDPYTHON': 'python',
 'BUILD_GNU_TYPE': 'x86_64-slackware-linux-gnu',
 'BYTESTR_DEPS': '\\',
 'CC': 'gcc -pthread',
 'CCSHARED': '-fPIC',
 ...
 'CONFIGURE_CPPFLAGS': '',
 'CONFIGURE_LDFLAGS': '',
 'CONFIG_ARGS': "'--prefix=/usr' '--libdir=/usr/lib64' '--mandir=/usr/man' "
                "'--docdir=/usr/doc/python3-3.5.2' '--with-threads' "
                "'--enable-ipv6' '--enable-shared' '--with-system-expat' "
                "'--with-system-ffi' '--build=x86_64-slackware-linux' "
 ...
 'HGTAG': '',
 'HGVERSION': '',
 'HOST_GNU_TYPE': 'x86_64-slackware-linux-gnu',
