...
"i486-linux-thread-multi-3.10.9-smp" or
	die "Errno architecture (i486-linux-thread-multi-3.10.9-smp) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
