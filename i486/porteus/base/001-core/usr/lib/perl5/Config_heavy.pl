...
## Package name      : perl5
## Source directory  : .
## Configuration time: Thu Sep  5 22:00:24 CDT 2013
## Configured by     : root
## Target system     : linux hive 3.10.9-smp #1 smp wed aug 21 15:27:17 cdt 2013 i686 amd phenom(tm) ii x6 1100t processor authenticamd gnulinux 
#
...
cf_time='Thu Sep  5 22:00:24 CDT 2013'
charbits='8'
charsize='1'
chgrp=''
chmod='chmod'
...
config_arg15='-Doptimize=-O2 -march=i486 -mtune=i686'
...
config_arg22='-Darchname=i486-linux'
...
myhostname='hive'
myuname='linux hive 3.10.9-smp #1 smp wed aug 21 15:27:17 cdt 2013 i686 amd phenom(tm) ii x6 1100t processor authenticamd gnulinux '
n='-n'
need_va_copy='undef'
...
phostname='hostname'
pidtype='pid_t'
plibpth='/lib/i486-slackware-linux/4.8.1 /lib /usr/lib/i486-slackware-linux/4.8.1 /usr/lib'
pmake=''
pr=''
prefix='/usr'
prefixexp='/usr'
