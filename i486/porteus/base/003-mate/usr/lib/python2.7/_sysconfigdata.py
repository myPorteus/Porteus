...
build_time_vars = {'AC_APPLE_UNIVERSAL_BUILD': 0,
 ...
 'CONFIG_ARGS': "'--prefix=/usr' '--libdir=/usr/lib' '--mandir=/usr/man' '--docdir=/usr/doc/python-2.7.5' '--with-threads' '--enable-ipv6' '--enable-shared' '--build=i486-slackware-linux' 'build_alias=i486-slackware-linux'",
 ...
 'HGTAG': 'hg id -t .',
 'HGVERSION': 'hg id -i .',
 'HOST_GNU_TYPE': 'i486-slackware-linux-gnu',
 'HURD_C_THREADS': 0,
